...
for src_ in source_list:
	...
	json_file = "enron analysis/sent_json_all_content/"+from_name+"-sent.json"
			...
			for filename in os.listdir(src_):
				...
				with open(src_file, 'r') as f:        			    
					...
					if to_email2 == to1:
						...
						json_content2 = '{"email": "'+str(to_email2)+'", "name": "'+str(to_name)+'", "label": "'+str(concat_f_char)+'", "subject": "'+str(subjects)+'", "date": "'+str(date)+'", "body": "'+str(email_body)+'"}, '

			#make sure the currently looped dict is not empty before appending			
			if json_content2 != '':	
				#open the file and append the dics as json																
				with open("enron analysis/sent_json_all_content/"+from_name+"-sent.json", "a") as f:
					#dump dict as json			
	...
	with open("enron analysis/sent_json_all_content/"+from_name+"-sent.json", "r+") as f:
